...
//todo          2.2.1 - Se o botao de tick e clicado, surgira um modal com um texto perguntando se confirma que voce realmente quer editar a task, um botao de cancela e um de confirma
//todo              2.2.1.1 - Se o botao de cancelar e clicado, o modal fecha.
//todo              2.2.1.2 - Se o botao de confirma e clicado, será enviada uma requisicao do tipo path com os valores presentes nos inputs da task, com a sua id e em sequencia o modal de confirmacao e o modal das opcoes sao fechados. Alem disso, o nome da task e  planned time deixam de ser inputs e voltam a ser textos
//todo          2.2.2 - Se o botao de X e clicado, o modal volta a ter as opcoes de editar/deletar e o nome e planned time da task deixam de ser inputs e voltam a ser textos